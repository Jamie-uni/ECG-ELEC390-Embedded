...
static _Bool cccd_written(ble_gatts_evt_write_t const * p_write_evt)
{
...
static inline void local_db_update(uint16_t conn_handle, _Bool update)
{
...
static _Bool local_db_update_in_evt(uint16_t conn_handle)
{
    _Bool set_procedure_as_pending = 0;
    _Bool success = 0;
...
void gcm_ble_evt_handler(ble_evt_t const * p_ble_evt)
{
    ...
    switch (p_ble_evt->header.evt_id)
    {
        ...
        case BLE_GATTS_EVT_SC_CONFIRM:
        {
            ...
            ble_conn_state_user_flag_set(conn_handle, m_flag_service_changed_sent, 0);
            ble_conn_state_user_flag_set(conn_handle, m_flag_service_changed_pending, 0);
            evt_send(&event);
            break;
        }
