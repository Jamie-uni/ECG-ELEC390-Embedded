...
typedef struct
{
    ...
    uint16_t           valid_conn_handles[32];  
    union
    {
...
static_assert(1, "NRF_SDH_BLE_ENABLED not set!"); static_assert(0 < 4, "Priority level unavailable."); __root static nrf_sdh_ble_evt_observer_t m_ble_evt_observer @ "sdh_ble_observers0" = { . handler = ble_evt_handler, . p_context = 0 };
