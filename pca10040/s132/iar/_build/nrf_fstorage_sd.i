...
#line 54 "C:\\nRF5_SDK_14.2.0_17b948a\\components\\libraries\\fstorage\\nrf_fstorage_sd.c"
#line 1 "C:\\nRF5_SDK_14.2.0_17b948a\\examples\\ble_peripheral\\ble_app_hrs\\pca10040\\s132\\iar\\..\\..\\..\\..\\..\\..\\components\\libraries\\atomic_fifo\\nrf_atfifo.h"
...
ret_code_t nrf_atfifo_alloc_put(nrf_atfifo_t * const p_fifo, void const * const p_var, size_t size, _Bool * const p_visible);
...
_Bool nrf_atfifo_item_put(nrf_atfifo_t * const p_fifo, nrf_atfifo_item_put_t * p_context);
...
ret_code_t nrf_atfifo_get_free(nrf_atfifo_t * const p_fifo, void * const p_var, size_t size, _Bool * p_released);
...
_Bool nrf_atfifo_item_free(nrf_atfifo_t * const p_fifo, nrf_atfifo_item_get_t * p_context);
...
_Bool nrf_fstorage_sdh_req_handler(nrf_sdh_req_evt_t, void *);
...
static nrf_fstorage_sd_op_t m_fifo_data[(4)+1]; static nrf_atfifo_t m_fifo_inst; static nrf_atfifo_t * const m_fifo = &m_fifo_inst;

 
static_assert(1, "NRF_SDH_SOC_ENABLED not set!"); static_assert(0 < 2, "Priority level unavailable."); __root static nrf_sdh_soc_evt_observer_t m_sys_obs @ "sdh_soc_observers0" = { . handler = nrf_fstorage_sys_evt_handler, . p_context = 0 };

 
static_assert(1, "NRF_SDH_ENABLED not set!"); static_assert(0 < 2, "Priority level unavailable."); __root nrf_sdh_req_observer_t const m_req_obs @ "sdh_req_observers0" =
{
    .handler = nrf_fstorage_sdh_req_handler,
};

 
static_assert(1, "NRF_SDH_ENABLED not set!"); static_assert(0 < 2, "Priority level unavailable."); __root static nrf_sdh_state_observer_t const m_state_obs @ "sdh_state_observers0" =
{
...
static _Bool queue_load_next(void)
{
...
static void queue_process(void)
{
    ...
    switch (rc)
    {
        case ((0x0) + 0):
        {
            ...
            {
                nrf_fstorage_sys_evt_handler(NRF_EVT_FLASH_OPERATION_SUCCESS, 0);
            }
        } break;
...
{
    nrf_atomic_flag_t queue_running = nrf_atomic_u32_fetch_store(&m_flags.queue_running, 1);
...
static _Bool on_operation_success(nrf_fstorage_sd_op_t * const p_op)
{
...
static _Bool on_operation_failure(nrf_fstorage_sd_op_t const * p_op)
{
    ((void)(p_op));
...
static _Bool is_busy(nrf_fstorage_t const * p_fs)
{
    ((void)(p_fs));
...
_Bool nrf_fstorage_sdh_req_handler(nrf_sdh_req_evt_t req, void * p_context)
{
    ((void)(req));
    ((void)(p_context));
