                                  ...
                                  pm_peer_data_bonding_t const * p_bonding_data2)
{
    ...
    _Bool duplicate_irk = ((memcmp(p_bonding_data1->peer_ble_id.id_info.irk,
    ...
    _Bool duplicate_addr = addr_compare(p_addr1, p_addr2);

    _Bool id_addrs =   ((p_addr1->addr_type != 0x02)
