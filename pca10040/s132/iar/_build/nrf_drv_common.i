...
#line 12 "C:\\Program Files (x86)\\IAR Systems\\Embedded Workbench 8.0\\arm\\inc\\c\\stddef.h"
...
void nrf_drv_common_irq_enable(IRQn_Type IRQn, uint8_t priority)
{
    if (0) { if ((((((priority)) > 1) && (((priority)) < 4)) || ((((priority)) > 4) && (((priority)) < 8)))) { } else { assert_nrf_callback((uint16_t)292, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\common\\nrf_drv_common.c"); } };
