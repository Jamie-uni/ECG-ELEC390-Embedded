...
extern nrf_log_module_dynamic_data_t m_nrf_log_nrf_sdh_logs_data_dynamic;
...
_Pragma("section = \"sdh_req_observers0\"");; _Pragma("section = \"sdh_req_observers1\"");;  static nrf_section_t const sdh_req_observers_array[] = { { . p_start = __section_begin("sdh_req_observers0"), . p_end = __section_end("sdh_req_observers0"), }, { . p_start = __section_begin("sdh_req_observers1"), . p_end = __section_end("sdh_req_observers1"), },  }; static nrf_section_set_t const sdh_req_observers = { . p_first = sdh_req_observers_array, . p_last = sdh_req_observers_array + (sizeof(sdh_req_observers_array) / sizeof((sdh_req_observers_array)[0])), . item_size = sizeof(nrf_sdh_req_observer_t), };


_Pragma("section = \"sdh_state_observers0\"");; _Pragma("section = \"sdh_state_observers1\"");;  static nrf_section_t const sdh_state_observers_array[] = { { . p_start = __section_begin("sdh_state_observers0"), . p_end = __section_end("sdh_state_observers0"), }, { . p_start = __section_begin("sdh_state_observers1"), . p_end = __section_end("sdh_state_observers1"), },  }; static nrf_section_set_t const sdh_state_observers = { . p_first = sdh_state_observers_array, . p_last = sdh_state_observers_array + (sizeof(sdh_state_observers_array) / sizeof((sdh_state_observers_array)[0])), . item_size = sizeof(nrf_sdh_state_observer_t), };


_Pragma("section = \"sdh_stack_observers0\"");; _Pragma("section = \"sdh_stack_observers1\"");;  static nrf_section_t const sdh_stack_observers_array[] = { { . p_start = __section_begin("sdh_stack_observers0"), . p_end = __section_end("sdh_stack_observers0"), }, { . p_start = __section_begin("sdh_stack_observers1"), . p_end = __section_end("sdh_stack_observers1"), },  }; static nrf_section_set_t const sdh_stack_observers = { . p_first = sdh_stack_observers_array, . p_last = sdh_stack_observers_array + (sizeof(sdh_stack_observers_array) / sizeof((sdh_stack_observers_array)[0])), . item_size = sizeof(nrf_sdh_stack_observer_t), };


static _Bool m_nrf_sdh_enabled;    
static _Bool m_nrf_sdh_suspended;  
static _Bool m_nrf_sdh_continue;   
...
static void softdevices_evt_irq_enable(void)
{
    ...
    do { const uint32_t LOCAL_ERR_CODE = (ret_code); if (LOCAL_ERR_CODE != ((0x0) + 0)) { do { app_error_handler_bare((LOCAL_ERR_CODE)); } while (0); } } while (0);
...
ret_code_t nrf_sdh_enable_request(void)
{
    ...
    m_nrf_sdh_enabled   = 1;
    m_nrf_sdh_continue  = 0;
    m_nrf_sdh_suspended = 0;
