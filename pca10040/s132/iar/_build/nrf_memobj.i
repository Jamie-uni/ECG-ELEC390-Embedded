...
#line 14 "C:\\Program Files (x86)\\IAR Systems\\Embedded Workbench 8.0\\arm\\inc\\c\\stdlib.h"
...
static_assert(sizeof(memobj_header_t) == sizeof(uint32_t), "unspecified message");
                      ...
                      _Bool read)
{
    ...
    if (0) { if (p_head->head_header . data . fields . chunk_cnt >= chunks_expected) { } else { assert_nrf_callback((uint16_t)186, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\libraries\\experimental_memobj\\nrf_memobj.c"); } };
                      ...
                      uint32_t offset)
{
    ...
    memobj_op(p_obj, p_data, len, offset, 0);
}
...
void nrf_memobj_read(nrf_memobj_t * p_obj,
                     ...
                     uint32_t offset)
{
    memobj_op(p_obj, p_data, len, offset, 1);
}
