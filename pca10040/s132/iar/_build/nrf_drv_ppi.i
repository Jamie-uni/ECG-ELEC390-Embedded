...
extern nrf_log_module_dynamic_data_t m_nrf_log_ppi_logs_data_dynamic;
...
static inline _Bool is_programmable_app_channel(nrf_ppi_channel_t channel)
{
    return ((((uint32_t)0x000FFFFFuL & ~((0xFFFE0000uL | 0uL | 0uL))) & nrf_drv_ppi_channel_to_mask(channel)) != 0);
}
...
static inline _Bool are_app_channels(uint32_t channel_mask)
{
...
static inline _Bool is_app_channel(nrf_ppi_channel_t channel)
{
...
static inline _Bool is_app_group(nrf_ppi_channel_group_t group)
{
...
static inline _Bool is_allocated_channel(nrf_ppi_channel_t channel)
{
...
static inline _Bool is_allocated_group(nrf_ppi_channel_group_t group)
{
...
uint32_t nrf_drv_ppi_channel_assign(nrf_ppi_channel_t channel, uint32_t eep, uint32_t tep)
{
    do { if (((((uint32_t *)eep) == 0))) { return ((0x0) + 14); } } while (0);
    do { if (((((uint32_t *)tep) == 0))) { return ((0x0) + 14); } } while (0);
