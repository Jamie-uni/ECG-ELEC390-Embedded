...
typedef enum  
{
    NRF_CLOCK_TASK_HFCLKSTART = (__INTADDR__((&((NRF_CLOCK_Type *)0)->TASKS_HFCLKSTART))),  
    NRF_CLOCK_TASK_HFCLKSTOP  = (__INTADDR__((&((NRF_CLOCK_Type *)0)->TASKS_HFCLKSTOP))),   
    NRF_CLOCK_TASK_LFCLKSTART = (__INTADDR__((&((NRF_CLOCK_Type *)0)->TASKS_LFCLKSTART))),  
    NRF_CLOCK_TASK_LFCLKSTOP  = (__INTADDR__((&((NRF_CLOCK_Type *)0)->TASKS_LFCLKSTOP))),   
    NRF_CLOCK_TASK_CAL        = (__INTADDR__((&((NRF_CLOCK_Type *)0)->TASKS_CAL))),         
    NRF_CLOCK_TASK_CTSTART    = (__INTADDR__((&((NRF_CLOCK_Type *)0)->TASKS_CTSTART))),     
    NRF_CLOCK_TASK_CTSTOP     = (__INTADDR__((&((NRF_CLOCK_Type *)0)->TASKS_CTSTOP)))       
} nrf_clock_task_t;                                                          
...
typedef enum  
{
    NRF_CLOCK_EVENT_HFCLKSTARTED = (__INTADDR__((&((NRF_CLOCK_Type *)0)->EVENTS_HFCLKSTARTED))),  
    NRF_CLOCK_EVENT_LFCLKSTARTED = (__INTADDR__((&((NRF_CLOCK_Type *)0)->EVENTS_LFCLKSTARTED))),  
    NRF_CLOCK_EVENT_DONE         = (__INTADDR__((&((NRF_CLOCK_Type *)0)->EVENTS_DONE))),          
    NRF_CLOCK_EVENT_CTTO         = (__INTADDR__((&((NRF_CLOCK_Type *)0)->EVENTS_CTTO)))           
} nrf_clock_event_t;                                                                
...
static inline _Bool nrf_clock_int_enable_check(nrf_clock_int_mask_t int_mask);
...
static inline _Bool nrf_clock_event_check(nrf_clock_event_t event);
...
static inline _Bool nrf_clock_lf_is_running(void);
...
static inline _Bool nrf_clock_hf_is_running(nrf_clock_hfclk_t clk_src);
...
_Bool nrf_drv_clock_init_check(void);
...
static void lfclk_stop(void)
{
    ...
    if (0) { if (!nrf_sdh_is_enabled()) { } else { assert_nrf_callback((uint16_t)132, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\clock\\nrf_drv_clock.c"); } };
...
void nrf_drv_clock_uninit(void)
{
    if (0) { if (m_clock_cb . module_initialized) { } else { assert_nrf_callback((uint16_t)212, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\clock\\nrf_drv_clock.c"); } };
...
void nrf_drv_clock_lfclk_request(nrf_drv_clock_handler_item_t * p_handler_item)
{
    if (0) { if (m_clock_cb . module_initialized) { } else { assert_nrf_callback((uint16_t)251, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\clock\\nrf_drv_clock.c"); } };
    ...
    if (0) { if (m_clock_cb . lfclk_requests > 0) { } else { assert_nrf_callback((uint16_t)279, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\clock\\nrf_drv_clock.c"); } };
}

void nrf_drv_clock_lfclk_release(void)
{
    if (0) { if (m_clock_cb . module_initialized) { } else { assert_nrf_callback((uint16_t)284, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\clock\\nrf_drv_clock.c"); } };
    if (0) { if (m_clock_cb . lfclk_requests > 0) { } else { assert_nrf_callback((uint16_t)285, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\clock\\nrf_drv_clock.c"); } };
...
_Bool nrf_drv_clock_lfclk_is_running(void)
{
    if (0) { if (m_clock_cb . module_initialized) { } else { assert_nrf_callback((uint16_t)298, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\clock\\nrf_drv_clock.c"); } };
...
void nrf_drv_clock_hfclk_request(nrf_drv_clock_handler_item_t * p_handler_item)
{
    if (0) { if (m_clock_cb . module_initialized) { } else { assert_nrf_callback((uint16_t)312, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\clock\\nrf_drv_clock.c"); } };
    ...
    if (0) { if (m_clock_cb . hfclk_requests > 0) { } else { assert_nrf_callback((uint16_t)340, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\clock\\nrf_drv_clock.c"); } };
}

void nrf_drv_clock_hfclk_release(void)
{
    if (0) { if (m_clock_cb . module_initialized) { } else { assert_nrf_callback((uint16_t)345, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\clock\\nrf_drv_clock.c"); } };
    if (0) { if (m_clock_cb . hfclk_requests > 0) { } else { assert_nrf_callback((uint16_t)346, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\clock\\nrf_drv_clock.c"); } };
...
_Bool nrf_drv_clock_hfclk_is_running(void)
{
    if (0) { if (m_clock_cb . module_initialized) { } else { assert_nrf_callback((uint16_t)359, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\clock\\nrf_drv_clock.c"); } };
...
static_assert(1, "NRF_SDH_SOC_ENABLED not set!"); static_assert(0 < 2, "Priority level unavailable."); __root static nrf_sdh_soc_evt_observer_t m_soc_evt_observer @ "sdh_soc_observers0" = { . handler = soc_evt_handler, . p_context = 0 };
...
static void sd_state_evt_handler(nrf_sdh_state_evt_t state, void * p_context)
{
    switch (state)
    {
        ...
        case NRF_SDH_EVT_STATE_DISABLED:
            ...
            if (0) { if (m_clock_cb . module_initialized) { } else { assert_nrf_callback((uint16_t)603, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\clock\\nrf_drv_clock.c"); } };
            nrf_drv_common_irq_enable(POWER_CLOCK_IRQn, 7);
...
static_assert(1, "NRF_SDH_ENABLED not set!"); static_assert(0 < 2, "Priority level unavailable."); __root static nrf_sdh_state_observer_t const m_sd_state_observer @ "sdh_state_observers0" =
{
