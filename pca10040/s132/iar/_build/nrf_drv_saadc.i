...
extern nrf_log_module_dynamic_data_t m_nrf_log_saadc_logs_data_dynamic;
...
static const nrf_drv_saadc_config_t m_default_config = { . resolution = (nrf_saadc_resolution_t)1, . oversample = (nrf_saadc_oversample_t)0, . interrupt_priority = 7, . low_power_mode = 0 };
...
void nrf_drv_saadc_uninit(void)
{
    if (0) { if (m_cb . state != NRF_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)279, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\saadc\\nrf_drv_saadc.c"); } };
    ...
    if (0) { if (timeout > 0) { } else { assert_nrf_callback((uint16_t)292, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\saadc\\nrf_drv_saadc.c"); } };
...
ret_code_t nrf_drv_saadc_channel_init(uint8_t                                  channel,
                                      nrf_saadc_channel_config_t const * const p_config)
{
    if (0) { if (m_cb . state != NRF_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)312, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\saadc\\nrf_drv_saadc.c"); } };
    if (0) { if (channel < 8) { } else { assert_nrf_callback((uint16_t)313, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\saadc\\nrf_drv_saadc.c"); } };
    
    if (0) { if ((nrf_saadc_oversample_get() == NRF_SAADC_OVERSAMPLE_DISABLED) || (m_cb . active_channels == 0)) { } else { assert_nrf_callback((uint16_t)316, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\saadc\\nrf_drv_saadc.c"); } };

    if (0) { if ((p_config->pin_p <= NRF_SAADC_INPUT_VDD) && (p_config->pin_p > NRF_SAADC_INPUT_DISABLED)) { } else { assert_nrf_callback((uint16_t)318, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\saadc\\nrf_drv_saadc.c"); } };

    if (0) { if (p_config->pin_n <= NRF_SAADC_INPUT_VDD) { } else { assert_nrf_callback((uint16_t)319, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\saadc\\nrf_drv_saadc.c"); } };
...
ret_code_t nrf_drv_saadc_channel_uninit(uint8_t channel)
{
    if (0) { if (channel < 8) { } else { assert_nrf_callback((uint16_t)364, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\saadc\\nrf_drv_saadc.c"); } }
    if (0) { if (m_cb . state != NRF_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)365, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\saadc\\nrf_drv_saadc.c"); } };
...
{
    if (0) { if (m_cb . state != NRF_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)465, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\saadc\\nrf_drv_saadc.c"); } };
    if (0) { if ((size % m_cb . active_channels) == 0) { } else { assert_nrf_callback((uint16_t)466, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\saadc\\nrf_drv_saadc.c"); } };
    ret_code_t err_code;
...
{
    if (0) { if (m_cb . state != NRF_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)533, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\saadc\\nrf_drv_saadc.c"); } };
...
{
    if (0) { if (m_cb . state != NRF_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)556, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\saadc\\nrf_drv_saadc.c"); } };
...
void nrf_drv_saadc_abort(void)
{
    if (nrf_drv_saadc_is_busy())
    {
        ...
        else
        {
            ...
            if (0) { if (timeout > 0) { } else { assert_nrf_callback((uint16_t)604, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\saadc\\nrf_drv_saadc.c"); } };
        }
...
void nrf_drv_saadc_limits_set(uint8_t channel, int16_t limit_low, int16_t limit_high)
{
    if (0) { if (m_cb . state != NRF_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)616, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\saadc\\nrf_drv_saadc.c"); } };
    if (0) { if (m_cb . event_handler) { } else { assert_nrf_callback((uint16_t)617, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\saadc\\nrf_drv_saadc.c"); } }; 
    if (0) { if (limit_low >= (-2048)) { } else { assert_nrf_callback((uint16_t)618, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\saadc\\nrf_drv_saadc.c"); } };
    if (0) { if (limit_high <= (2047)) { } else { assert_nrf_callback((uint16_t)619, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\saadc\\nrf_drv_saadc.c"); } };
    if (0) { if (limit_low < limit_high) { } else { assert_nrf_callback((uint16_t)620, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\saadc\\nrf_drv_saadc.c"); } };
