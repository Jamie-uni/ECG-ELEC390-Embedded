...
void nrf_fprintf_buffer_flush(nrf_fprintf_ctx_t * const p_ctx)
{
    if (0) { if (p_ctx != 0) { } else { assert_nrf_callback((uint16_t)49, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\external\\fprintf\\nrf_fprintf.c"); } };
...
void nrf_fprintf(nrf_fprintf_ctx_t * const p_ctx,
                 char const *              p_fmt,
                                           ...)
{
    if (0) { if (p_ctx != 0) { } else { assert_nrf_callback((uint16_t)66, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\external\\fprintf\\nrf_fprintf.c"); } };
    if (0) { if (p_ctx->fwrite != 0) { } else { assert_nrf_callback((uint16_t)67, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\external\\fprintf\\nrf_fprintf.c"); } };
    if (0) { if (p_ctx->p_io_buffer != 0) { } else { assert_nrf_callback((uint16_t)68, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\external\\fprintf\\nrf_fprintf.c"); } };
    if (0) { if (p_ctx->io_buffer_size > 0) { } else { assert_nrf_callback((uint16_t)69, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\external\\fprintf\\nrf_fprintf.c"); } };
