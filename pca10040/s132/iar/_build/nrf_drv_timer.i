...
static timer_control_block_t m_cb[(1+0+0+0+0)];
                              ...
                              nrf_timer_event_handler_t timer_event_handler)
{
    ...
    if (0) { if (((p_instance ->p_reg == ((NRF_TIMER_Type *) 0x40008000UL)) && 1) || (p_instance ->p_reg != ((NRF_TIMER_Type *) 0x40008000UL))) { } else { assert_nrf_callback((uint16_t)75, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\timer\\nrf_drv_timer.c"); } };
    if (0) { if (((p_instance ->p_reg == ((NRF_TIMER_Type *) 0x40009000UL)) && 0) || (p_instance ->p_reg != ((NRF_TIMER_Type *) 0x40009000UL))) { } else { assert_nrf_callback((uint16_t)76, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\timer\\nrf_drv_timer.c"); } };
    if (0) { if (((p_instance ->p_reg == ((NRF_TIMER_Type *) 0x4000A000UL)) && 0) || (p_instance ->p_reg != ((NRF_TIMER_Type *) 0x4000A000UL))) { } else { assert_nrf_callback((uint16_t)77, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\timer\\nrf_drv_timer.c"); } };

    if (0) { if (((p_instance ->p_reg == ((NRF_TIMER_Type *) 0x4001A000UL)) && 0) || (p_instance ->p_reg != ((NRF_TIMER_Type *) 0x4001A000UL))) { } else { assert_nrf_callback((uint16_t)79, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\timer\\nrf_drv_timer.c"); } };


    if (0) { if (((p_instance ->p_reg == ((NRF_TIMER_Type *) 0x4001B000UL)) && 0) || (p_instance ->p_reg != ((NRF_TIMER_Type *) 0x4001B000UL))) { } else { assert_nrf_callback((uint16_t)82, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\timer\\nrf_drv_timer.c"); } };


    if (0) { if (p_instance ->p_reg != ((NRF_TIMER_Type *) 0x40008000UL)) { } else { assert_nrf_callback((uint16_t)85, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\timer\\nrf_drv_timer.c"); } };

    if (0) { if (p_config) { } else { assert_nrf_callback((uint16_t)87, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\timer\\nrf_drv_timer.c"); } };
    ...
    if (0) { if (( ((p_instance ->p_reg == ((NRF_TIMER_Type *) 0x40008000UL)) && ((32 == 8 ? (p_config->bit_width == NRF_TIMER_BIT_WIDTH_8) : (32 == 16 ? (p_config->bit_width == NRF_TIMER_BIT_WIDTH_8) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_16) : (32 == 24 ? (p_config->bit_width == NRF_TIMER_BIT_WIDTH_8) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_16) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_24) : (32 == 32 ? (p_config->bit_width == NRF_TIMER_BIT_WIDTH_8) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_16) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_24) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_32) : 0)))))) || ((p_instance ->p_reg == ((NRF_TIMER_Type *) 0x40009000UL)) && ((32 == 8 ? (p_config->bit_width == NRF_TIMER_BIT_WIDTH_8) : (32 == 16 ? (p_config->bit_width == NRF_TIMER_BIT_WIDTH_8) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_16) : (32 == 24 ? (p_config->bit_width == NRF_TIMER_BIT_WIDTH_8) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_16) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_24) : (32 == 32 ? (p_config->bit_width == NRF_TIMER_BIT_WIDTH_8) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_16) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_24) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_32) : 0)))))) || ((p_instance ->p_reg == ((NRF_TIMER_Type *) 0x4000A000UL)) && ((32 == 8 ? (p_config->bit_width == NRF_TIMER_BIT_WIDTH_8) : (32 == 16 ? (p_config->bit_width == NRF_TIMER_BIT_WIDTH_8) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_16) : (32 == 24 ? (p_config->bit_width == NRF_TIMER_BIT_WIDTH_8) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_16) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_24) : (32 == 32 ? (p_config->bit_width == NRF_TIMER_BIT_WIDTH_8) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_16) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_24) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_32) : 0)))))) || ((p_instance ->p_reg == ((NRF_TIMER_Type *) 0x4001A000UL)) && ((32 == 8 ? (p_config->bit_width == NRF_TIMER_BIT_WIDTH_8) : (32 == 16 ? (p_config->bit_width == NRF_TIMER_BIT_WIDTH_8) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_16) : (32 == 24 ? (p_config->bit_width == NRF_TIMER_BIT_WIDTH_8) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_16) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_24) : (32 == 32 ? (p_config->bit_width == NRF_TIMER_BIT_WIDTH_8) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_16) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_24) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_32) : 0)))))) || ((p_instance ->p_reg == ((NRF_TIMER_Type *) 0x4001B000UL)) && ((32 == 8 ? (p_config->bit_width == NRF_TIMER_BIT_WIDTH_8) : (32 == 16 ? (p_config->bit_width == NRF_TIMER_BIT_WIDTH_8) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_16) : (32 == 24 ? (p_config->bit_width == NRF_TIMER_BIT_WIDTH_8) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_16) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_24) : (32 == 32 ? (p_config->bit_width == NRF_TIMER_BIT_WIDTH_8) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_16) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_24) || (p_config->bit_width == NRF_TIMER_BIT_WIDTH_32) : 0)))))) )) { } else { assert_nrf_callback((uint16_t)112, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\timer\\nrf_drv_timer.c"); } };
...
void nrf_drv_timer_uninit(nrf_drv_timer_t const * const p_instance)
{
    ...
    nrf_timer_shorts_disable(p_instance->p_reg, 0xffffffffU);
    nrf_timer_int_disable(p_instance->p_reg, 0xffffffffU);
...
void nrf_drv_timer_clear(nrf_drv_timer_t const * const p_instance)
{
    if (0) { if (m_cb[p_instance ->instance_id]. state != NRF_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)190, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\timer\\nrf_drv_timer.c"); } };
    nrf_timer_task_trigger(p_instance->p_reg, NRF_TIMER_TASK_CLEAR);
}

void nrf_drv_timer_increment(nrf_drv_timer_t const * const p_instance)
{
    if (0) { if (m_cb[p_instance ->instance_id]. state == NRF_DRV_STATE_POWERED_ON) { } else { assert_nrf_callback((uint16_t)196, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\timer\\nrf_drv_timer.c"); } };
    if (0) { if (nrf_timer_mode_get(p_instance ->p_reg) != NRF_TIMER_MODE_TIMER) { } else { assert_nrf_callback((uint16_t)197, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\timer\\nrf_drv_timer.c"); } };
...
uint32_t nrf_drv_timer_capture(nrf_drv_timer_t const * const p_instance,
                               nrf_timer_cc_channel_t cc_channel)
{
    if (0) { if (m_cb[p_instance ->instance_id]. state != NRF_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)205, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\timer\\nrf_drv_timer.c"); } };
    if (0) { if (cc_channel < p_instance ->cc_channel_count) { } else { assert_nrf_callback((uint16_t)206, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\timer\\nrf_drv_timer.c"); } };
...
void nrf_drv_timer_compare_int_enable(nrf_drv_timer_t const * const p_instance,
                                      uint32_t channel)
{
    if (0) { if (m_cb[p_instance ->instance_id]. state != NRF_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)255, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\timer\\nrf_drv_timer.c"); } };
    if (0) { if (channel < p_instance ->cc_channel_count) { } else { assert_nrf_callback((uint16_t)256, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\timer\\nrf_drv_timer.c"); } };
...
void nrf_drv_timer_compare_int_disable(nrf_drv_timer_t const * const p_instance,
                                       uint32_t channel)
{
    if (0) { if (m_cb[p_instance ->instance_id]. state != NRF_DRV_STATE_UNINITIALIZED) { } else { assert_nrf_callback((uint16_t)267, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\timer\\nrf_drv_timer.c"); } };
    if (0) { if (channel < p_instance ->cc_channel_count) { } else { assert_nrf_callback((uint16_t)268, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\timer\\nrf_drv_timer.c"); } };
...
{
    irq_handler(((NRF_TIMER_Type *) 0x40008000UL), &m_cb[0],
        4);
}
