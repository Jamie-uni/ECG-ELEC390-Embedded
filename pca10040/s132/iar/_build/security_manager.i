...
typedef struct
{
    ...
    _Bool                   params_reply_called;  
} sec_params_reply_context_t;

static _Bool                            m_module_initialized;      

static ble_gap_sec_params_t            m_sec_params;              
static ble_gap_sec_params_t          * mp_sec_params = 0;      
static _Bool                            m_sec_params_set = 0;  
                                      ...
                                      ble_gap_sec_params_t * p_sec_params)
{
    if ((err_code != ((0x0) + 0)) && (err_code != ((0x0) + 17)) && (err_code != ((0x0) + 8)))
    {
        ...
        if (err_code == ((0x0) + 13))
        {
            ...
            evt.params.conn_sec_failed.procedure = ((p_sec_params != 0) && p_sec_params->bond)
                                                 ? PM_LINK_SECURED_PROCEDURE_BONDING
                                                 : PM_LINK_SECURED_PROCEDURE_PAIRING;
                              ...
                              _Bool     send_events)
{
    ...
    else
    {
        ...
        params_req_send(conn_handle, 0, &context);
...
static void params_reply_pending_process(ble_conn_state_user_flag_id_t flag_id)
{
    ...
    if (sdk_mapped_flags_any_set(flag_collection))
    {
        ...
        for (uint32_t i = 0; i < conn_handle_list.len; i++)
        {
            ...
            if (pending)
            {
                smd_params_reply_perform(conn_handle_list.flag_keys[i], 0);
            }
        }
    }
}
                               ...
                               void           const * p_context)
{
    ...
    p_sec_params_reply_context->params_reply_called = 1;
