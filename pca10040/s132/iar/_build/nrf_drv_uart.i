...
typedef enum
{
    ...
    NRF_UART_TASK_STARTRX = (__INTADDR__((&((NRF_UART_Type *)0)->TASKS_STARTRX))),  
    NRF_UART_TASK_STOPRX  = (__INTADDR__((&((NRF_UART_Type *)0)->TASKS_STOPRX))),   
    NRF_UART_TASK_STARTTX = (__INTADDR__((&((NRF_UART_Type *)0)->TASKS_STARTTX))),  
    NRF_UART_TASK_STOPTX  = (__INTADDR__((&((NRF_UART_Type *)0)->TASKS_STOPTX))),   
    NRF_UART_TASK_SUSPEND = (__INTADDR__((&((NRF_UART_Type *)0)->TASKS_SUSPEND))),  
...
typedef enum
{
    ...
    NRF_UART_EVENT_CTS    = (__INTADDR__((&((NRF_UART_Type *)0)->EVENTS_CTS))),    
    NRF_UART_EVENT_NCTS   = (__INTADDR__((&((NRF_UART_Type *)0)->EVENTS_NCTS))),   
    NRF_UART_EVENT_RXDRDY = (__INTADDR__((&((NRF_UART_Type *)0)->EVENTS_RXDRDY))), 
    NRF_UART_EVENT_TXDRDY = (__INTADDR__((&((NRF_UART_Type *)0)->EVENTS_TXDRDY))), 
    NRF_UART_EVENT_ERROR  = (__INTADDR__((&((NRF_UART_Type *)0)->EVENTS_ERROR))),  
    NRF_UART_EVENT_RXTO   = (__INTADDR__((&((NRF_UART_Type *)0)->EVENTS_RXTO)))    
...
static inline _Bool nrf_uart_event_check(NRF_UART_Type * p_reg, nrf_uart_event_t event);
...
static inline _Bool nrf_uart_int_enable_check(NRF_UART_Type * p_reg, uint32_t int_mask);
...
typedef enum
{
    ...
    NRF_UARTE_TASK_STARTRX   = (__INTADDR__((&((NRF_UARTE_Type *)0)->TASKS_STARTRX))),
    NRF_UARTE_TASK_STOPRX    = (__INTADDR__((&((NRF_UARTE_Type *)0)->TASKS_STOPRX))), 
    NRF_UARTE_TASK_STARTTX   = (__INTADDR__((&((NRF_UARTE_Type *)0)->TASKS_STARTTX))),
    NRF_UARTE_TASK_STOPTX    = (__INTADDR__((&((NRF_UARTE_Type *)0)->TASKS_STOPTX))), 
    NRF_UARTE_TASK_FLUSHRX   = (__INTADDR__((&((NRF_UARTE_Type *)0)->TASKS_FLUSHRX))) 
...
typedef enum
{
    ...
    NRF_UARTE_EVENT_CTS       = (__INTADDR__((&((NRF_UARTE_Type *)0)->EVENTS_CTS))),      
    NRF_UARTE_EVENT_NCTS      = (__INTADDR__((&((NRF_UARTE_Type *)0)->EVENTS_NCTS))),     
    NRF_UARTE_EVENT_ENDRX     = (__INTADDR__((&((NRF_UARTE_Type *)0)->EVENTS_ENDRX))),    
    NRF_UARTE_EVENT_ENDTX     = (__INTADDR__((&((NRF_UARTE_Type *)0)->EVENTS_ENDTX))),    
    NRF_UARTE_EVENT_ERROR     = (__INTADDR__((&((NRF_UARTE_Type *)0)->EVENTS_ERROR))),    
    NRF_UARTE_EVENT_RXTO      = (__INTADDR__((&((NRF_UARTE_Type *)0)->EVENTS_RXTO))),     
    NRF_UARTE_EVENT_RXSTARTED = (__INTADDR__((&((NRF_UARTE_Type *)0)->EVENTS_RXSTARTED))),
    NRF_UARTE_EVENT_TXSTARTED = (__INTADDR__((&((NRF_UARTE_Type *)0)->EVENTS_TXSTARTED))),
    NRF_UARTE_EVENT_TXSTOPPED = (__INTADDR__((&((NRF_UARTE_Type *)0)->EVENTS_TXSTOPPED))) 
...
static inline _Bool nrf_uarte_event_check(NRF_UARTE_Type * p_reg, nrf_uarte_event_t event);
...
static inline _Bool nrf_uarte_int_enable_check(NRF_UARTE_Type * p_reg, nrf_uarte_int_mask_t int_mask);
...
_Bool nrf_drv_uart_rx_ready(nrf_drv_uart_t const * p_instance);
...
#line 142 "C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\uart\\nrf_drv_uart.c"
    else { nrf_uart_baudrate_set(p_instance ->reg . p_uart, p_config->baudrate); nrf_uart_configure(p_instance ->reg . p_uart, p_config->parity, p_config->hwfc); nrf_uart_txrx_pins_set(p_instance ->reg . p_uart, p_config->pseltxd, p_config->pselrxd); if (p_config->hwfc == NRF_UART_HWFC_ENABLED) { if (p_config->pselcts != 0xFFFFFFFF) { nrf_gpio_cfg_input(p_config->pselcts, NRF_GPIO_PIN_NOPULL); } if (p_config->pselrts != 0xFFFFFFFF) { nrf_gpio_pin_set(p_config->pselrts); nrf_gpio_cfg_output(p_config->pselrts); } nrf_uart_hwfc_pins_set(p_instance ->reg . p_uart, p_config->pselrts, p_config->pselcts); } }
#line 161 "C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\uart\\nrf_drv_uart.c"
}
...
ret_code_t nrf_drv_uart_init(const nrf_drv_uart_t * p_instance, nrf_drv_uart_config_t const * p_config,
                             nrf_uart_event_handler_t event_handler)
{
    if (0) { if (p_config) { } else { assert_nrf_callback((uint16_t)272, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\uart\\nrf_drv_uart.c"); } };
...
{
    uart_control_block_t * p_cb = &m_cb[p_instance->drv_inst_idx];
    if (0) { if (p_cb->state == NRF_DRV_STATE_INITIALIZED) { } else { assert_nrf_callback((uint16_t)408, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\uart\\nrf_drv_uart.c"); } };
    if (0) { if (length>0) { } else { assert_nrf_callback((uint16_t)409, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\uart\\nrf_drv_uart.c"); } };
    if (0) { if (p_data) { } else { assert_nrf_callback((uint16_t)410, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\uart\\nrf_drv_uart.c"); } };
...
static inline ret_code_t nrf_drv_uart_rx_for_uart(const nrf_drv_uart_t * p_instance, uint8_t * p_data, uint8_t length, _Bool second_buffer)
{
    ret_code_t err_code;
...
static inline ret_code_t nrf_drv_uart_rx_for_uarte(const nrf_drv_uart_t * p_instance, uint8_t * p_data, uint8_t length, _Bool second_buffer)
{
    ret_code_t err_code = ((0x0) + 0);
...
ret_code_t nrf_drv_uart_rx(const nrf_drv_uart_t * p_instance, uint8_t * p_data, uint8_t length)
{
    ...
    if (0) { if (m_cb[p_instance ->drv_inst_idx]. state == NRF_DRV_STATE_INITIALIZED) { } else { assert_nrf_callback((uint16_t)600, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\uart\\nrf_drv_uart.c"); } };
    if (0) { if (length>0) { } else { assert_nrf_callback((uint16_t)601, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\uart\\nrf_drv_uart.c"); } };
...
void nrf_drv_uart_rx_enable(const nrf_drv_uart_t * p_instance)
{
    ...
    if (m_cb[p_instance ->drv_inst_idx]. use_easy_dma) { if (0) { if (0) { } else { assert_nrf_callback((uint16_t)696, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\uart\\nrf_drv_uart.c"); } }; }
...
void nrf_drv_uart_rx_disable(const nrf_drv_uart_t * p_instance)
{
    ...
    if (m_cb[p_instance ->drv_inst_idx]. use_easy_dma) { if (0) { if (0) { } else { assert_nrf_callback((uint16_t)713, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\drivers_nrf\\uart\\nrf_drv_uart.c"); } }; }
