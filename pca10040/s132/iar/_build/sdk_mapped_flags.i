...
static_assert((sizeof(sdk_mapped_flags_t) * 8) >= 32, "unspecified message");
...
static inline void sdk_mapped_flags_set_by_index(sdk_mapped_flags_t * p_flags, uint16_t index)
{
    *p_flags |= (1U << index);
}
...
static inline void sdk_mapped_flags_clear_by_index(sdk_mapped_flags_t * p_flags, uint16_t index)
{
    *p_flags &= ~(1U << index);
}
...
static inline _Bool sdk_mapped_flags_get_by_index(sdk_mapped_flags_t flags, uint16_t index)
{
