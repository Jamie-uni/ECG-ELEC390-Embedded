...
void app_util_critical_region_enter(uint8_t *p_nested)
{
    ...
    if (0) { if (APP_LEVEL_PRIVILEGED == privilege_level_get()) { } else { assert_nrf_callback((uint16_t)67, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\libraries\\util\\app_util_platform.c"); } }
...
void app_util_critical_region_exit(uint8_t nested)
{
    ...
    if (0) { if (APP_LEVEL_PRIVILEGED == privilege_level_get()) { } else { assert_nrf_callback((uint16_t)81, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\libraries\\util\\app_util_platform.c"); } }
