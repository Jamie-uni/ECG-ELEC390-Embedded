...
extern nrf_log_module_dynamic_data_t m_nrf_log_nrf_sdh_soc_logs_data_dynamic;
...
_Pragma("section = \"sdh_soc_observers0\"");; _Pragma("section = \"sdh_soc_observers1\"");;  static nrf_section_t const sdh_soc_observers_array[] = { { . p_start = __section_begin("sdh_soc_observers0"), . p_end = __section_end("sdh_soc_observers0"), }, { . p_start = __section_begin("sdh_soc_observers1"), . p_end = __section_end("sdh_soc_observers1"), },  }; static nrf_section_set_t const sdh_soc_observers = { . p_first = sdh_soc_observers_array, . p_last = sdh_soc_observers_array + (sizeof(sdh_soc_observers_array) / sizeof((sdh_soc_observers_array)[0])), . item_size = sizeof(nrf_sdh_soc_evt_observer_t), };
...
static_assert(1, "NRF_SDH_ENABLED not set!"); static_assert(0 < 2, "Priority level unavailable."); __root static nrf_sdh_stack_observer_t const m_nrf_sdh_soc_evts_poll @ "sdh_stack_observers0" =
{
