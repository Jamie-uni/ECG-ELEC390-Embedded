...
#line 41 "C:\\nRF5_SDK_14.2.0_17b948a\\components\\ble\\peer_manager\\peer_manager.c"
#line 1 "C:\\nRF5_SDK_14.2.0_17b948a\\examples\\ble_peripheral\\ble_app_hrs\\pca10040\\s132\\iar\\..\\..\\..\\..\\..\\..\\components\\softdevice\\s132\\headers\\ble_err.h"
...
static ble_conn_state_user_flag_id_t m_bonded_flag_id;                   
...
{
    do { if (((((p_sm_evt) == 0)))) { return ; } } while (0);

    switch (p_sm_evt->evt_id)
    {
        case PM_EVT_CONN_SEC_SUCCEEDED:
        {
            _Bool bonded = p_sm_evt->params.conn_sec_succeeded.procedure
                                == PM_LINK_SECURED_PROCEDURE_BONDING;
...
void pm_im_evt_handler(pm_evt_t * p_im_evt)
{
    switch (p_im_evt->evt_id)
    {
        case PM_EVT_BONDED_PEER_CONNECTED:
            ble_conn_state_user_flag_set(p_im_evt->conn_handle, m_bonded_flag_id, 1);
            break;
        default:
...
static_assert(1, "NRF_SDH_BLE_ENABLED not set!"); static_assert(1 < 4, "Priority level unavailable."); __root static nrf_sdh_ble_evt_observer_t m_ble_evt_observer @ "sdh_ble_observers1" = { . handler = ble_evt_handler, . p_context = 0 };
