...
#line 44 "C:\\nRF5_SDK_14.2.0_17b948a\\components\\libraries\\pwr_mgmt\\nrf_pwr_mgmt.c"
#line 1 "C:\\nRF5_SDK_14.2.0_17b948a\\examples\\ble_peripheral\\ble_app_hrs\\pca10040\\s132\\iar\\..\\..\\..\\..\\..\\..\\components\\libraries\\mutex\\nrf_mtx.h"
...
static inline _Bool nrf_mtx_trylock(nrf_mtx_t * p_mtx);
...
static inline void nrf_mtx_init(nrf_mtx_t * p_mtx)
{
    if (0) { if (p_mtx != 0) { } else { assert_nrf_callback((uint16_t)114, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\examples\\ble_peripheral\\ble_app_hrs\\pca10040\\s132\\iar\\..\\..\\..\\..\\..\\..\\components\\libraries\\mutex\\nrf_mtx.h"); } };
...
static inline void nrf_mtx_destroy(nrf_mtx_t * p_mtx)
{
    if (0) { if (p_mtx != 0) { } else { assert_nrf_callback((uint16_t)122, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\examples\\ble_peripheral\\ble_app_hrs\\pca10040\\s132\\iar\\..\\..\\..\\..\\..\\..\\components\\libraries\\mutex\\nrf_mtx.h"); } };
...
static inline _Bool nrf_mtx_trylock(nrf_mtx_t * p_mtx)
{
    if (0) { if (p_mtx != 0) { } else { assert_nrf_callback((uint16_t)133, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\examples\\ble_peripheral\\ble_app_hrs\\pca10040\\s132\\iar\\..\\..\\..\\..\\..\\..\\components\\libraries\\mutex\\nrf_mtx.h"); } };
...
static inline void nrf_mtx_unlock(nrf_mtx_t * p_mtx)
{
    if (0) { if (p_mtx != 0) { } else { assert_nrf_callback((uint16_t)146, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\examples\\ble_peripheral\\ble_app_hrs\\pca10040\\s132\\iar\\..\\..\\..\\..\\..\\..\\components\\libraries\\mutex\\nrf_mtx.h"); } };
    if (0) { if (*p_mtx == 1) { } else { assert_nrf_callback((uint16_t)147, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\examples\\ble_peripheral\\ble_app_hrs\\pca10040\\s132\\iar\\..\\..\\..\\..\\..\\..\\components\\libraries\\mutex\\nrf_mtx.h"); } };
...
_Pragma("section = \"pwr_mgmt_data0\"");; _Pragma("section = \"pwr_mgmt_data1\"");; _Pragma("section = \"pwr_mgmt_data2\"");;  static nrf_section_t const pwr_mgmt_data_array[] = { { . p_start = __section_begin("pwr_mgmt_data0"), . p_end = __section_end("pwr_mgmt_data0"), }, { . p_start = __section_begin("pwr_mgmt_data1"), . p_end = __section_end("pwr_mgmt_data1"), }, { . p_start = __section_begin("pwr_mgmt_data2"), . p_end = __section_end("pwr_mgmt_data2"), },  }; static nrf_section_set_t const pwr_mgmt_data = { . p_first = pwr_mgmt_data_array, . p_last = pwr_mgmt_data_array + (sizeof(pwr_mgmt_data_array) / sizeof((pwr_mgmt_data_array)[0])), . item_size = sizeof(nrf_pwr_mgmt_shutdown_handler_t), };

static nrf_pwr_mgmt_evt_t   m_pwr_mgmt_evt;     
 
static nrf_mtx_t            m_sysoff_mtx;        
static _Bool                 m_shutdown_started;  
static nrf_section_iter_t   m_handlers_iter;     
     ...
     static inline void pwr_mgmt_fpu_sleep_prepare(void)
     {
        ...
        if (0) { if ((fpscr & 0x07) == 0) { } else { assert_nrf_callback((uint16_t)118, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\libraries\\pwr_mgmt\\nrf_pwr_mgmt.c"); } };
     }
...
void nrf_pwr_mgmt_run(void)
{
    ...
    if (nrf_sdh_is_enabled())
    {
        ...
        if (0) { if ((ret_code == ((0x0) + 0)) || (ret_code == ((0x0) + 2))) { } else { assert_nrf_callback((uint16_t)345, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\libraries\\pwr_mgmt\\nrf_pwr_mgmt.c"); } };
        ((void)(ret_code));
    }
    else
...
static void shutdown_process(void)
{
    ...
    for (
 ;
         nrf_section_iter_get(&m_handlers_iter) != 0;
    ...
    else
    {
        ...
        if (nrf_sdh_is_enabled())
        {
            ...
            if (0) { if ((ret_code == ((0x0) + 0)) || (ret_code == ((0x0) + 2))) { } else { assert_nrf_callback((uint16_t)411, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\components\\libraries\\pwr_mgmt\\nrf_pwr_mgmt.c"); } };
            ((void)(ret_code));
        }
