...
#line 58 "C:\\nRF5_SDK_14.2.0_17b948a\\examples\\ble_peripheral\\ble_app_hrs\\pca10040\\s132\\iar\\..\\..\\..\\..\\..\\..\\components\\libraries\\util\\sdk_common.h"
#line 1 "C:\\nRF5_SDK_14.2.0_17b948a\\examples\\ble_peripheral\\ble_app_hrs\\pca10040\\s132\\iar\\..\\..\\..\\..\\..\\..\\components\\device\\compiler_abstraction.h"
...
extern nrf_log_module_dynamic_data_t m_nrf_log_nrf_sdh_ble_logs_data_dynamic;
...
_Pragma("section = \"sdh_ble_observers0\"");; _Pragma("section = \"sdh_ble_observers1\"");; _Pragma("section = \"sdh_ble_observers2\"");; _Pragma("section = \"sdh_ble_observers3\"");;  static nrf_section_t const sdh_ble_observers_array[] = { { . p_start = __section_begin("sdh_ble_observers0"), . p_end = __section_end("sdh_ble_observers0"), }, { . p_start = __section_begin("sdh_ble_observers1"), . p_end = __section_end("sdh_ble_observers1"), }, { . p_start = __section_begin("sdh_ble_observers2"), . p_end = __section_end("sdh_ble_observers2"), }, { . p_start = __section_begin("sdh_ble_observers3"), . p_end = __section_end("sdh_ble_observers3"), },  }; static nrf_section_set_t const sdh_ble_observers = { . p_first = sdh_ble_observers_array, . p_last = sdh_ble_observers_array + (sizeof(sdh_ble_observers_array) / sizeof((sdh_ble_observers_array)[0])), . item_size = sizeof(nrf_sdh_ble_evt_observer_t), };
...
static void nrf_sdh_ble_evts_poll(void * p_context)
{
    ...
    while (1)
    {
        _Pragma("data_alignment = 4") uint8_t evt_buffer[(((sizeof(ble_evt_t)) < ((((__INTADDR__((&((ble_evt_t *)0)->evt . gattc_evt . params . rel_disc_rsp . includes))) + ((247) - 2) / 6 * sizeof(ble_gattc_include_t)) < ((__INTADDR__((&((ble_evt_t *)0)->evt . gattc_evt . params . attr_info_disc_rsp . info . attr_info16))) + ((247) - 2) / 4 * sizeof(ble_gattc_attr_info16_t)) ? ((__INTADDR__((&((ble_evt_t *)0)->evt . gattc_evt . params . attr_info_disc_rsp . info . attr_info16))) + ((247) - 2) / 4 * sizeof(ble_gattc_attr_info16_t)) : ((__INTADDR__((&((ble_evt_t *)0)->evt . gattc_evt . params . rel_disc_rsp . includes))) + ((247) - 2) / 6 * sizeof(ble_gattc_include_t)))) ? ((((__INTADDR__((&((ble_evt_t *)0)->evt . gattc_evt . params . rel_disc_rsp . includes))) + ((247) - 2) / 6 * sizeof(ble_gattc_include_t)) < ((__INTADDR__((&((ble_evt_t *)0)->evt . gattc_evt . params . attr_info_disc_rsp . info . attr_info16))) + ((247) - 2) / 4 * sizeof(ble_gattc_attr_info16_t)) ? ((__INTADDR__((&((ble_evt_t *)0)->evt . gattc_evt . params . attr_info_disc_rsp . info . attr_info16))) + ((247) - 2) / 4 * sizeof(ble_gattc_attr_info16_t)) : ((__INTADDR__((&((ble_evt_t *)0)->evt . gattc_evt . params . rel_disc_rsp . includes))) + ((247) - 2) / 6 * sizeof(ble_gattc_include_t)))) : (sizeof(ble_evt_t))))];
    ...
    if (ret_code != ((0x0) + 5))
    {
        do { app_error_handler_bare((ret_code)); } while (0);
    }
}


static_assert(1, "NRF_SDH_ENABLED not set!"); static_assert(0 < 2, "Priority level unavailable."); __root static nrf_sdh_stack_observer_t const m_nrf_sdh_ble_evts_poll @ "sdh_stack_observers0" =
{
