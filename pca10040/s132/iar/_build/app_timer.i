...
static_assert(7 == 7, "unspecified message");
...
static_assert(sizeof(timer_node_t) == 32, "unspecified message");
...
static_assert(sizeof(timer_op_queue_t) % 4 == 0, "unspecified message");
...
static _Bool timer_list_remove(timer_node_t * p_timer)
{
