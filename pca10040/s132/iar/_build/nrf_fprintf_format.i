...
void nrf_fprintf_fmt(nrf_fprintf_ctx_t * const p_ctx,
                    ...
                    va_list *                  p_args)
{
    if (0) { if (p_ctx != 0) { } else { assert_nrf_callback((uint16_t)318, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\external\\fprintf\\nrf_fprintf_format.c"); } };

    if (0) { if (p_ctx->fwrite != 0) { } else { assert_nrf_callback((uint16_t)320, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\external\\fprintf\\nrf_fprintf_format.c"); } };
    if (0) { if (p_ctx->p_io_buffer != 0) { } else { assert_nrf_callback((uint16_t)321, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\external\\fprintf\\nrf_fprintf_format.c"); } };
    if (0) { if (p_ctx->io_buffer_size > 0) { } else { assert_nrf_callback((uint16_t)322, (uint8_t *)"C:\\nRF5_SDK_14.2.0_17b948a\\external\\fprintf\\nrf_fprintf_format.c"); } };
