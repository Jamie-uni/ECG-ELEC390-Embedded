...
static_assert((__INTADDR__((&((nrf_atfifo_postag_pos_t *)0)->wr))) == 0, "unspecified message");
static_assert((__INTADDR__((&((nrf_atfifo_postag_pos_t *)0)->rd))) == 2, "unspecified message");
...
static _Bool nrf_atfifo_wspace_req(nrf_atfifo_t * const p_fifo, nrf_atfifo_postag_t * const p_old_tail);
...
static _Bool nrf_atfifo_rspace_req(nrf_atfifo_t * const p_fifo, nrf_atfifo_postag_t * const p_old_head);
...
static _Bool nrf_atfifo_space_clear(nrf_atfifo_t * const p_fifo);
...
_Bool nrf_atfifo_wspace_req(nrf_atfifo_t * const p_fifo, nrf_atfifo_postag_t * const p_old_tail)
{
    volatile _Bool ret;
    ...
    __asm volatile(
        ...
        :  
            [p_fifo]          "r"(p_fifo),
            [offset_tail]     "J"((__INTADDR__((&((nrf_atfifo_t *)0)->tail)))),
            [offset_head_wr]  "J"((__INTADDR__((&((nrf_atfifo_t *)0)->head))) + (__INTADDR__((&((nrf_atfifo_postag_pos_t *)0)->wr)))),
            [offset_item_size]"J"((__INTADDR__((&((nrf_atfifo_t *)0)->item_size)))),
            [offset_buf_size] "J"((__INTADDR__((&((nrf_atfifo_t *)0)->buf_size)))),
            [true_val]        "I"(1),
            [false_val]       "I"(0)
        :  
            "cc");
...
_Bool nrf_atfifo_rspace_req(nrf_atfifo_t * const p_fifo, nrf_atfifo_postag_t * const p_old_head)
{
    volatile _Bool ret;
    ...
    __asm volatile(
        ...
        :  
            [p_fifo]          "r"(p_fifo),
            [offset_head]     "J"((__INTADDR__((&((nrf_atfifo_t *)0)->head)))),
            [offset_tail_rd]  "J"((__INTADDR__((&((nrf_atfifo_t *)0)->tail))) + (__INTADDR__((&((nrf_atfifo_postag_pos_t *)0)->rd)))),
            [offset_item_size]"J"((__INTADDR__((&((nrf_atfifo_t *)0)->item_size)))),
            [offset_buf_size] "J"((__INTADDR__((&((nrf_atfifo_t *)0)->buf_size)))),
            [true_val]        "I"(1),
            [false_val]       "I"(0)
...
_Bool nrf_atfifo_space_clear(nrf_atfifo_t * const p_fifo)
{
    volatile _Bool ret;
    uint32_t old_head;  
    uint32_t new_head;
...
static_assert(sizeof(nrf_atfifo_postag_t) == sizeof(uint32_t), "unspecified message");
...
ret_code_t nrf_atfifo_clear(nrf_atfifo_t * const p_fifo)
{
    _Bool released = nrf_atfifo_space_clear(p_fifo);
    return released ? ((0x0) + 0) : ((0x0) + 17);
}


ret_code_t nrf_atfifo_alloc_put(nrf_atfifo_t * const p_fifo, void const * p_var, size_t size, _Bool * const p_visible)
{
