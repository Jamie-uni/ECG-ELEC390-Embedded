...
#line 1 "C:\\nRF5_SDK_14.2.0_17b948a\\examples\\ble_peripheral\\ble_app_hrs\\pca10040\\s132\\iar\\..\\..\\..\\..\\..\\..\\components\\softdevice\\s132\\headers\\ble_types.h"
...
#line 49 "C:\\nRF5_SDK_14.2.0_17b948a\\components\\ble\\ble_services\\ble_dis\\ble_dis.c"
#line 1 "C:\\nRF5_SDK_14.2.0_17b948a\\examples\\ble_peripheral\\ble_app_hrs\\pca10040\\s132\\iar\\..\\..\\..\\..\\..\\..\\components\\libraries\\util\\app_error.h"
...
{
    do { const uint32_t LOCAL_BOOLEAN_VALUE = (p_sys_id != 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler_bare((0)); } while (0); } } while (0);
    do { const uint32_t LOCAL_BOOLEAN_VALUE = (p_encoded_buffer != 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler_bare((0)); } while (0); } } while (0);
...
static void pnp_id_encode(uint8_t * p_encoded_buffer, ble_dis_pnp_id_t const * p_pnp_id)
{
    ...
    do { const uint32_t LOCAL_BOOLEAN_VALUE = (p_pnp_id != 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler_bare((0)); } while (0); } } while (0);
    do { const uint32_t LOCAL_BOOLEAN_VALUE = (p_encoded_buffer != 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler_bare((0)); } while (0); } } while (0);
    ...
    do { const uint32_t LOCAL_BOOLEAN_VALUE = (len == 7); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler_bare((0)); } while (0); } } while (0);
}
                         ...
                         ble_gatts_char_handles_t      * p_handles)
{
    ...
    do { const uint32_t LOCAL_BOOLEAN_VALUE = (p_char_value != 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler_bare((0)); } while (0); } } while (0);
    do { const uint32_t LOCAL_BOOLEAN_VALUE = (char_len > 0); if (!LOCAL_BOOLEAN_VALUE) { do { app_error_handler_bare((0)); } while (0); } } while (0);
