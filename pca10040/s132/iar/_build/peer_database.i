...
#line 1 "C:\\nRF5_SDK_14.2.0_17b948a\\examples\\ble_peripheral\\ble_app_hrs\\pca10040\\s132\\iar\\..\\..\\..\\..\\..\\..\\components\\softdevice\\s132\\headers\\ble_gap.h"
...
static uint32_t            m_n_pending_writes;                              
...
static void write_buf_length_words_set(pm_peer_data_const_t * p_peer_data)
{
    switch (p_peer_data->data_id)
    {
        ...
        case PM_PEER_DATA_ID_GATT_LOCAL:
            p_peer_data->length_words = ((((p_peer_data->p_local_gatt_db->len) + (__INTADDR__((&((pm_peer_data_local_gatt_db_t *)0)->data)))) + 3) >> 2);
            break;
        default:
...
static _Bool write_buf_store_in_event(pdb_buffer_record_t * p_write_buffer_record)
{
    ret_code_t err_code;
    pm_evt_t   event;
...
static void reattempt_previous_operations(_Bool retry_flash_full)
{
    ...
    for (uint32_t i = 0; i < 2; i++)
    {
        ...
        {
            _Bool success = write_buf_store_in_event(&m_write_buffer_records[i]);
...
ret_code_t pdb_init()
{
    ...
    do { _Pragma("data_alignment = 4") static uint8_t buffer_memory[(2) * ((sizeof(pm_peer_data_bonding_t)))]; static uint8_t mutex_memory[((7 + (2)) >> 3)]; ret = pm_buffer_init((&m_write_buffer), buffer_memory, (2) * ((sizeof(pm_peer_data_bonding_t))), mutex_memory, ((7 + (2)) >> 3), (2), ((sizeof(pm_peer_data_bonding_t)))); } while (0);
                             ...
                             pm_peer_data_t  * p_peer_data)
{
    ...
    {
        p_peer_data->p_local_gatt_db->len = (((p_peer_data->length_words) * (4)) - (__INTADDR__((&((pm_peer_data_local_gatt_db_t *)0)->data))));
    }
